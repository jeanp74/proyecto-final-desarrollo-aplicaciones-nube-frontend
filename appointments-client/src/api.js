...
const DOCTORS_DEFAULT =
  import.meta.env.VITE_DOCTORS_API_BASE || process.env.VITE_DOCTORS_API_BASE || "https://doctors-proyecto-final-desarrollo-b7aqbdbpcgd0d7bq.brazilsouth-01.azurewebsites.net/";
